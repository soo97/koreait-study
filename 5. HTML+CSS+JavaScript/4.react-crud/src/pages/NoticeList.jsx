            ...
            <div className="container">
                ...
                {noticeList.length === 0 ? (
                    ...
                    <div className="post-list" id="announcementList">
                        {noticeList.map((post) => (
                            <div className="post-item" key={post.id} onClick={() => goToDetail(post.id)}>
                ...
                {totalPages > 1 && (
                    <div className="pagination">
                        ...
                        {pageNumbers.map((pageNum) => (
                            <button key={pageNum} className={`page-btn ${currentPage === pageNum ? 'active' : ''}`} onClick={() => handlePageChange(pageNum)}>
                                {pageNum}
                            </button>
                        ))}
