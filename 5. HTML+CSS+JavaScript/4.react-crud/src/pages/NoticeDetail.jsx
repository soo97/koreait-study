...
function NoticeDetail() {
    const { data, postId, isLoading, isError, error, isWriterCheck, currentUser, goToList, goToEdit, deletePost, closeDeleteModal, confirmDelete, showDeleteModal } = useNoticeDetailHook();
                    ...
                    <div className="post-detail">
                        <div className="detail-header">
                            <div>
                                ...
                                <div className="detail-meta">
                                    ...
                                    {/* 조회수 추가 */}
                                    <span id="detailViews">{data.viewCount}</span>
                                </div>
                            </div>
                            {/* 수정, 삭제 버튼 추가 */}
                            {isWriterCheck && (
                        ...
                        {data.files.length > 0 && (
                            <div id="detailImage" style={{ margin: "2rem 0" }}>
                                <img src={`http://localhost:8080${data.files[0].filePath}`} style={{width: 200, height: 200}}></img>
                            </div>
                        )}
