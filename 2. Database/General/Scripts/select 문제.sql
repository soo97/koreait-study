...
SELECT * FROM employees WHERE hire_date >= '1996-01-01';
...
SELECT * FROM salariesWHERE salary < 40000 OR salary > 100000;
-- Q16. employees 테이블에서 성별이 F이면서 1995년 이후 입사한 사원을 조회하세요.
SELECT * FROM employees
WHERE gender = 'F' AND from_date >= 1996-01-01;
-- Q17. salaries 테이블에서 급여가 50000부터 70000 사이인 사원을 조회하세요.
SELECT * FROM salaries WHERE salay BETWEEN 50000 AND 69999;
-- Q18. employees 테이블에서 입사일이 1990년부터 1995년 사이인 사원을 조회하세요.
SELECT * from employees WHERE hire_date BETWEEN '1990-01-01' AND '1994-12-31';
-- Q19. employees 테이블에서 사번이 10010부터 10020 사이인 사원을 조회하세요.
SELECT * FROM employees WHERE emp_no BETWEEN 10010 AND 10019;
